...
public class Methref {
	 ...
	 *        String::length;
	 * - 람다식을 통해 구현한 기능이 이미 정의 되어있는 다른 메소드의 기능을 그대로 사용한 경우,
	 *   다른 메서드의 이름을 통해 호출할 메서드를 정의하는것
	 *   
	 *  메서드 참조의 종류
	 *  1. static메소드참조
	 *  2. 일반메소드 참조
	 ...
	 *  
	 *   
	 *  - 메소드 참조문은 컴파일 과정이 다시한번 람다식으로 변환됨
	 *  - 메소드 참조문 사용시 메모리를 좀 더 효율적으로 사용 가능하므로 사용하는걸 권장
	 */
	public static void main(String[] args) {
		
		Consumer<String> print; //<5> -> void
